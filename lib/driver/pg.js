...
var PgDriver = Base.extend({
    ...
    createColumnConstraint: function(spec, options) {
        ...
        if (typeof spec.references != 'undefined') {
            constraint.push('REFERENCES');
            constraint.push(spec.references);

            if (typeof spec.onDelete != 'undefined') {
              constraint.push('ON DELETE');
              constraint.push(spec.onDelete.toUpperCase());
            }
        }
