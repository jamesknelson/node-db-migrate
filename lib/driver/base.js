...
module.exports = Base = Class.extend({
  ...
  createTable: thunkify(function(tableName, options, callback) {
  ...
  dropTable: thunkify(function(tableName, options, callback) {
  ...
  renameTable: thunkify(function(tableName, newTableName, callback) {
    throw new Error('not yet implemented');
  }),

  addColumn: thunkify(function(tableName, columnName, columnSpec, callback) {
  ...
  removeColumn: thunkify(function(tableName, columnName, callback) {
    throw new Error('not yet implemented');
  }),

  renameColumn: thunkify(function(tableName, oldColumnName, newColumnName, callback) {
    throw new Error('not yet implemented');
  }),

  changeColumn: thunkify(function(tableName, columnName, columnSpec, callback) {
    throw new Error('not yet implemented');
  }),

  addIndex: thunkify(function(tableName, indexName, columns, unique, callback) {
  ...
  insert: thunkify(function(tableName, columnNameArray, valueArray, callback) {
  ...
  removeIndex: thunkify(function(tableName, indexName, callback) {
